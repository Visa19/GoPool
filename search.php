...
<title>GoPool Portal | Car Listing</title>
<!--Bootstrap -->
...
where tblvehicles.VehiclesTitle=:search || tblvehicles.FuelType=:search || tblbrands.BrandName=:search || tblvehicles.AvailableDistrict=:search";
