...
$sql="update tblrideshare_vehicles set Vimage1=:vimage1";
$query = $dbh->prepare($sql);
$query->bindParam(':vimage1',$vimage,PDO::PARAM_STR);
...
<div class="col-sm-8">
<img src="admin/img/Veh_share_img/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
