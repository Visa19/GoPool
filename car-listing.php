...
<title>GoPool | Car Listings</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Vehicle Rental Listing</h1>
      </div>
      <ul class="coustom-breadcrumb">
          <li><a href="index.php">Home</a></li>
        <li>Vehicle Rental  Listing</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> Cars Are Available.</span></p>
</div>
</div>

<?php $sql = "SELECT tblvehicles.id,tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
{
    $vehicle_id = htmlentities($result->id);
$sql = 'SELECT 
          ...
          <div class="product-listing-content">
            ...
            <ul>
              ...
              <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> model</li>
               <li><i class="fa fa-location-arrow" aria-hidden="true"></i><?php echo htmlentities($result->AvailableDistrict);?> </li>
            ...
            <form action="search-carresult.php" method="post">
              <div class="form-group select">
                <select class="form-control" name="brand">
                  <option>Select Prefered Brand</option>
...
<?php }} ?>
              ...
              <div class="form-group select">
                <select class="form-control" name="av_dis">
                  <option>Select Prefered Distric</option>
