...
<title>GoPool | Car Listing</title>
<!--Bootstrap -->
...
$brand=$_POST['brand'];
$av_dis=$_POST['av_dis'];
$sql = "SELECT id from tblvehicles where tblvehicles.VehiclesBrand=:brand and tblvehicles.AvailableDistrict=:av_dis";
$query = $dbh -> prepare($sql);
$query -> bindParam(':brand',$brand, PDO::PARAM_STR);
$query -> bindParam(':av_dis',$av_dis, PDO::PARAM_STR);
$query->execute();
...
$sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblvehicles.VehiclesBrand=:brand and tblvehicles.AvailableDistrict=:av_dis";
$query = $dbh -> prepare($sql);
$query -> bindParam(':brand',$brand, PDO::PARAM_STR);
$query -> bindParam(':av_dis',$av_dis, PDO::PARAM_STR);
$query->execute();
...
<?php }} ?>
              ...
              <div class="form-group select">
                <select class="form-control">
                  <option>Select Available Distric</option>
