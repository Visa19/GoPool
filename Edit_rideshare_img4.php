...
$sql="update tblrideshare_vehicles set Vimage4=:vimage4";
$query = $dbh->prepare($sql);
$query->bindParam(':vimage4',$vimage,PDO::PARAM_STR);
...
<div class="col-sm-8">
<img src="admin/img/Veh_share_img/<?php echo htmlentities($result->Vimage4);?>" width="300" height="200" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
