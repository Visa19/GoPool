...
$sql="update tblrideshare_vehicles set VehiclesTitle=:vehicletitle,VehiclesBrand=:brand,VehiclesOverview=:vehicleoverview,VehicleNumber=:vehnum,FuelType=:fueltype,ModelYear=:modelyear,SeatingCapacity=:seatingcapacity,AirConditioner=:airconditioner,PowerDoorLocks=:powerdoorlocks,AntiLockBrakingSystem=:antilockbrakingsys,BrakeAssist=:brakeassist,PowerSteering=:powersteering,DriverAirbag=:driverairbag,PassengerAirbag=:passengerairbag,PowerWindows=:powerwindow,CDPlayer=:cdplayer,CentralLocking=:centrallocking,CrashSensor=:crashcensor,LeatherSeats=:leatherseats";
$query = $dbh->prepare($sql);
$query->bindParam(':vehicletitle',$vehicletitle,PDO::PARAM_STR);
$query->bindParam(':brand',$brand,PDO::PARAM_STR);
$query->bindParam(':vehicleoverview',$vehicleoverview,PDO::PARAM_STR);
$query->bindParam(':vehnum',$vehnum,PDO::PARAM_STR);
...
<head>
	...
	<title>GoPool |  Edit Vehicle Info</title>
...
<label class="col-sm-2 control-label">Can't edit fields with <span style="color:red">*</span></label>
						<div class="row">
							<div class="col-md-12">
...
<div class="col-sm-4">
    <input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->VehiclesTitle)?>" required readonly>
</div>
<label class="col-sm-2 control-label">Select Brand<span style="color:red">*</span></label>
<div class="col-sm-4">
    <input type="text" name="vehiclebrand" class="form-control" value="<?php echo htmlentities($result->VehiclesBrand)?>" required readonly>
</div>
</div>
...
<div class="col-sm-4">
    <input type="text" name="vehnum" class="form-control" value="<?php echo htmlentities($result->VehicleNumber);?>" required readonly>
</div>
<label class="col-sm-2 control-label">Fuel Type<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="fueltype" class="form-control" value="<?php echo htmlentities($result->FuelType);?>" required readonly>
</div>
</div>
...
<div class="col-sm-4">
    <input type="text" name="modelyear" class="form-control" value="<?php echo htmlentities($result->ModelYear);?>" required readonly>
</div>
...
<div class="form-group">
<div class="col-sm-4">
Image 1 <img src="admin/img/Veh_share_img/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
<a href="Edit_rideshare_img1.php">Change Image 1</a>
</div>
<div class="col-sm-4">
Image 2<img src="admin/img/Veh_share_img/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="Edit_rideshare_img2.php">Change Image 2</a>
</div>
<div class="col-sm-4">
Image 3<img src="admin/img/Veh_share_img/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<a href="Edit_rideshare_img3.php">Change Image 3</a>
</div>
</div>
...
<div class="form-group">
<div class="col-sm-4">
Image 4<img src="admin/img/Veh_share_img/<?php echo htmlentities($result->Vimage4);?>" width="300" height="200" style="border:solid 1px #000">
<a href="Edit_rideshare_img4.php">Change Image 4</a>
</div>
<div class="col-sm-4">
Image 5
...
<a href="Edit_rideshare_img5.php">Change Image 5</a>
<?php } ?>
</div>
