...
move_uploaded_file($_FILES["img1"]["tmp_name"],"admin/img/Veh_share_img/".$_FILES["img2"]["name"]);
$sql="update tblrideshare_vehicles set Vimage2=:vimage2";
$query = $dbh->prepare($sql);
$query->bindParam(':vimage2',$vimage,PDO::PARAM_STR);
...
<div class="col-sm-8">
<img src="admin/img/Veh_share_img/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
